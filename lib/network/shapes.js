...
if (typeof CanvasRenderingContext2D !== 'undefined') {
   ...
   */
  CanvasRenderingContext2D.prototype.circleAroundCircle = function (x, y, r, color) {
    this.beginPath();
    this.fillStyle = color;
    this.arc(x, y, r + 12, 0, 2 * Math.PI, false);
    this.fill();
    this.closePath();

    this.beginPath();
    this.fillStyle = "#f6f6f6";
    this.arc(x, y, r + 6, 0, 2 * Math.PI, false);
    this.fill();
    this.closePath();
